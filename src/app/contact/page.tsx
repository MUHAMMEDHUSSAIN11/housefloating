      ...
      <div className="font-sans max-w-screen-lg mx-auto pt-20 p-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg p-4 shadow-md">
                    ...
                    <p className="text-blue-600"><a href="tel: +1-800-123-4567">+91 9497252368</a></p>
                    <p className="text-blue-600"><a href="mailto: info@housefloating.com">hfsupport@gmail.com</a></p>
                    <br/>
