export default function GpayBanner() {
    return (
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-blue-500 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                ...
                <a href="https://wa.me/918714038424" className="flex-none rounded-full bg-green-500 px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">
