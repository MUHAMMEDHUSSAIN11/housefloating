                ...
                <div className="container flex flex-wrap">
                    <div className="flex flex-wrap w-full">
                        <div className="md:pr-10 md:py-6">
                            <h1 className="font-sans font-semibold text-2xl text-gray-900 mb-5 ">Day Night Cruise Schedule</h1>
                            ...
                            <div className="flex relative pb-12">
                                ...
                                <div className="grow pl-4">
                                    ...
                                    <p className="text-sm text-gray-900 mt-2">Time: 04:30 PM</p>
                                    <p className="leading-relaxed">
...
export default PrivateDayNightSteps;
