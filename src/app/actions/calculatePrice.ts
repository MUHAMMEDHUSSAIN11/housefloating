...
//     let additionalAdults: number = 0;
//     let additionalAdultCost: number = 0;
//     let additionalChildCost: number = 0;
    
//     if (cruiseType === TravelMode.DayCruise && finalAdultCount > minDayGuest) {
//       additionalAdults = finalAdultCount - minDayGuest;
//       additionalAdultCost = additionalAdults * dayAdultAddOnPrice;
//       additionalChildCost = finalChildCount * dayChildAddOnPrice;
//     } else if (cruiseType === TravelMode.OverNight && finalAdultCount > minNightGuest) {
//       additionalAdults = finalAdultCount - minNightGuest;
